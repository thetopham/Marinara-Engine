                ...
                {isGame && (
                  ...
                  >
                    ...
                    <div className="grid gap-2 md:grid-cols-2">
                      <GameStoryboardPromptTemplateSelect
...
// Storyboard prompt controls
function GameStoryboardPromptTemplateSelect({
  label,
  description,
  options,
  selectedId,
  ...
  return (
    <div className="rounded-lg bg-[var(--background)]/75 px-2.5 py-2 ring-1 ring-[var(--border)]">
      <label className="flex flex-col gap-1.5">
        ...
        <select
          value={activeOption?.id ?? GAME_STORYBOARD_ILLUSTRATION_PROMPT_TEMPLATE_ID}
          onChange={(event) => onChange(event.target.value)}
