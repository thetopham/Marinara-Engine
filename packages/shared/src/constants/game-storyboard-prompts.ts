...
export const GAME_STORYBOARD_BUILT_IN_PROMPT_TEMPLATES: AgentPromptTemplateOption[] = [
  {
    ...
    description: "Single-scene keyframe illustrations for normal storyboard viewing. Avoids comic text and panels.",
    promptTemplate: GAME_STORYBOARD_STILL_PROMPT_TEMPLATE,
  },
  {
    id: GAME_STORYBOARD_ANIMATION_PROMPT_TEMPLATE_ID,
    name: "Comic Page Keyframes",
    description: "Comic page keyframes with panels and text, intended as first frames for automatic animations.",
