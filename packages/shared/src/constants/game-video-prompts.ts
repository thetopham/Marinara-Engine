...
export const COMIC_PAGE_GAME_VIDEO_PROMPT_TEMPLATE = [
  ...
  "A brief full-page establishment is allowed when it fits the direction, then enter the first panel and progress through the sequence at a pace the ${durationSeconds}-second clip can support.",
  ...
  "Within each panel beat, animate one primary subject action clearly, use one simple camera move or a locked camera, add only supporting environmental motion, and finish on the final panel's ending pose or hold.",
  ...
  "Preserve deliberate comic lettering while the page is visible, but do not invent, rewrite, or animate extra dialogue, captions, subtitles, UI, logos, or watermarks.",
].join("\n");
